---
description: Systematically debug a problem using the 4-phase process — root cause investigation first, then pattern analysis, then hypothesis and testing, then implementation. Never propose fixes before completing Phase 1.
