---
description: Design-first brainstorming session. Explores intent, constraints, and approaches through dialogue before any implementation. Produces an approved spec document, then hands off to /plan. Use before any new feature, component, or behavior change.
allowed-tools: Glob, Grep, Read, LS, Write, Bash(git log:*), Bash(git diff:*), TodoWrite
---

# Brainstorming: $ARGUMENTS

Turn this idea into a fully formed design through collaborative dialogue. No code is written during this session.
...
### 7. Hand off to /plan
After spec approval, invoke the `/plan` command with the spec path to create the implementation plan. Do not write code directly.
